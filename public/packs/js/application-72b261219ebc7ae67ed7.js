...
document.addEventListener('turbolinks:load', function () {
  ...
  if (mypageBtnContainer) {
    mypageBtnContainer.addEventListener('mmouseClicked', function () {
      mypageDropdown.style.display = 'block';
    });
    mypageBtnContainer.addEventListener('mouseClicked', function () {
...
/******/ });
//# sourceMappingURL=application-72b261219ebc7ae67ed7.js.map